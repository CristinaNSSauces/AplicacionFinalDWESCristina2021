...
class UsuarioPDO implements UsuarioDB{
     ...
     * @return mixed[]  Si existe,un array con un objeto de tipo Usuario con los datos de la base de datos y la fechaHoraUltimaConexion anterior. Si no existe null.
     */
    public static function validarUsuario($codUsuario, $password){
        ...
        if($resultadoConsulta->rowCount()>0){ // si la consulta me devuleve algun resultado
            ...
            $fechaHoraUltimaConexion = $oUsuarioConsulta -> T01_FechaHoraUltimaConexion;
